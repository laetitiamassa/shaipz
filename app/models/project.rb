class Project < ActiveRecord::Base
  ...
  has_attached_file :picture, { :styles => { :head => "1814x489#", :medium => "930x259#", :thumb => "300x150#" }, :default_url => "/assets/project_missing_:style.png" }.merge!(PAPERCLIP_STORAGE_OPTIONS)
  ...
  attr_accessible :name, :picture, :address, :total_amount, :maximum_shaipz, :total_space, :source_link, :disabled_at, :cohousing, :city, :zipcode, :project_status, :share_on_facebook, :event_description, :event_type, :event_date, :hide_street_from_non_participants, :average_district_price, :leader_thought, :owner_id, :is_private

  attr_accessible :name, :picture, :address, :total_amount, :maximum_shaipz, :total_space, :source_link, :disabled_at, :cohousing, :city, :zipcode, :project_status, :share_on_facebook, :event_description, :event_type, :event_date, :hide_street_from_non_participants, :average_district_price, :leader_thought, :owner_id, :is_private, :as => :admin 
  ...
  def coming_event
    event_date && event_date >= Time.now
  end
