class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :remember_me, :cohousing, :favorite_areas, :minimum_space, :maximum_budget, :picture, :name, :personal_status, :hide_budget, :personal_timing, :skill, :role, :rationale, :ideal_project, :ideal_neighbour, :people_plan_request, :newly, :garden, :garage
  ...
  def is_pro
    email.include?("stanislas.bareel@hotmail.com" || "stanislas.bareel@yahoo.fr" || "christian.sole@dexia.com")
  end
